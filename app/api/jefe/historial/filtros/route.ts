// app/api/jefe/historial/filtros/route.ts
// GET: Empresa/Sitio/Área para poblar los combos del historial de Jefe.
// Se piden desde el cliente (no bloquean el render inicial de la
// pantalla) porque Jefe no tiene alcance restringido — ve toda la
