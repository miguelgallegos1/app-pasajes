...
const MENU_POR_ROL: Record<string, ItemMenu[]> = {
  ...
  SUPER_ADMIN: [
    ...
    { label: "Rutas", href: "/th/rutas", icono: IconoRuta },
    { label: "Revisión", href: "/coordinador/revision", icono: IconoCheck },
    { label: "Historial Revisión", href: "/coordinador/historial", icono: IconoReloj },
    { label: "Pagos", href: "/nomina/pagos", icono: IconoDinero },
    { label: "Historial Pagos", href: "/nomina/historial", icono: IconoReloj },
    ...
    <div className="min-h-screen bg-neutral-950 text-white flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        >
          ...
          <div
            className={`absolute left-0 top-0 bottom-0 w-64 bg-neutral-900 border-r border-neutral-800/70 p-4 flex flex-col
