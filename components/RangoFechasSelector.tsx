  ...
  return (
    <div className="relative" ref={contenedorRef}>
      <button
        ...
        `}
      >
        <span className={desde && hasta ? "text-neutral-900 font-medium" : "text-neutral-400"}>{etiqueta}</span>
            ...
            {celdas.map((dia, i) => {
              ...
              return (
                <div
                  ...
                  className={enRango || esInicio || esFin ? "bg-orange-50" : ""}
                  style={{
                ...
                >
                  <button
                    ...
                    className={`h-9 w-9 mx-auto rounded-full text-sm font-medium transition-all block
                      ...
                      ${!esInicio && !esFin && esHoy ? "ring-1 ring-orange-400 text-orange-600" : ""}
                      ${!esInicio && !esFin && !esHoy && !deshabilitado ? "hover:bg-orange-100 text-neutral-700" : ""}
